...
public class MedicineAssignJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(medicineBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 60, 200, 30));
        ...
        add(observationBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 60, 200, 30));

        assignButton.setBackground(new java.awt.Color(204, 255, 255));
        assignButton.setFont(new java.awt.Font("Segoe UI", 3, 12)); // NOI18N
        ...
        add(assignButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 140, -1, -1));

        displayValue.setText("jLabel1");
        add(displayValue, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 80, 110, 50));
